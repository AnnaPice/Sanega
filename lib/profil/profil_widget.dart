                      ...
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/Skarmavbild_2023-10-06_kl._17.26.08.png',
                              width: 100.0,
                              height: 100.0,
                              fit: BoxFit.cover,
                            ),
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            context.goNamedAuth('Valkommen', context.mounted);
                          },
                          text: 'Log Out',
                    ...
                    child: Container(
                      ...
                      child: StreamBuilder<List<SubjectsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<SubjectsRecord> listViewSubjectsRecordList =
                              snapshot.data!;
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewSubjectsRecordList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewSubjectsRecord =
                                  listViewSubjectsRecordList[listViewIndex];
