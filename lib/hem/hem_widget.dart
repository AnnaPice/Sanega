...
import 'hem_model.dart';
export 'hem_model.dart';

class HemWidget extends StatefulWidget {
  const HemWidget({Key? key}) : super(key: key);

  @override
  _HemWidgetState createState() => _HemWidgetState();
}

class _HemWidgetState extends State<HemWidget> with TickerProviderStateMixin {
  late HemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HemModel());
